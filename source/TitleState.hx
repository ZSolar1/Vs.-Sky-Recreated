...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.updateHitbox();
		// hlogoBl.screenCenter();
		// logoBl.color = FlxColor.BLACK;

		swagShader = new ColorSwap();
		gfDance = new FlxSprite(-720, 90);
		...
		FlxTween.tween(logoBl, {y: logoBl.y - 750}, 1, {ease: FlxEase.smootherStepInOut, startDelay: 1});
		FlxTween.tween(gfDance, {x: gfDance.x + 1300}, 1, {ease: FlxEase.smootherStepInOut, startDelay:2 });
