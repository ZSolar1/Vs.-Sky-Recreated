...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			["Vs. Sky Mod Creator"],
			['bb-panzu',			'bb-panzu',			'Creator of the Vs. Sky mod',							'https://twitter.com/bbsub3',			'389A58'],
			['Mod Creator'],
			['ZSolar1',			'zsolar1',		"Creator of the Sky Recreated Mod",							'https://sites.google.com/view/zsolar1/home',		'FFFFFF']
		];
